...
import 'package:simple_flutter/public_profile1.dart';

void main() {
  runApp(PublicProfile1Output());
}

class PublicProfile1Output extends StatelessWidget {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 30),
                  // Adjust the height to make space for the avatar
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Align(
                          ...
                          child: IconButton(
                            icon:
                            Icon(Icons.more_vert, color: Color(0xFF232323)),
                            onPressed: () {
                              // menu
                            },
                          ),
                        ...
                        Center(
                          child: OutlinedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => PublicProfile1()),
                              );
                            },
                            child: Text(
                              "Following",
